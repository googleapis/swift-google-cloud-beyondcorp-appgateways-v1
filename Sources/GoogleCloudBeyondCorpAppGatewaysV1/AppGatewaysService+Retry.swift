...
extension Clients {
  final class AppGatewaysServiceRetry: AppGatewaysServiceStub {
    ...
    public init(_ inner: any AppGatewaysServiceStub, options: GoogleGax.ClientOptions) {
      self.inner = inner
    ...
    public func listAppGateways(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: ListAppGatewaysRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func getAppGateway(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetAppGatewayRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func createAppGateway(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CreateAppGatewayRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func deleteAppGateway(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: DeleteAppGatewayRequest, o: GoogleGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
